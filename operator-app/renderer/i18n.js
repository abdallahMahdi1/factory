...
const STRINGS = {
  en: {
    ...
    closeBlocked: "A job is still running on this machine.\n\nStop the job first so its time is recorded correctly.\n\nClose anyway?",
    scrapCode: "Code",
  ...
  ar: {
    ...
    closeBlocked: "لا يزال هناك عمل قيد التشغيل على هذه الماكينة.\n\nأوقف العمل أولًا حتى يُسجَّل وقته بشكل صحيح.\n\nهل تريد الإغلاق على أي حال؟",
    scrapCode: "الرمز",
  ...
  hi: {
    ...
    closeBlocked: "इस मशीन पर एक काम अभी भी चल रहा है।\n\nपहले काम बंद करें ताकि उसका समय सही दर्ज हो।\n\nफिर भी बंद करें?",
    scrapCode: "कोड",
